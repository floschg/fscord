...
handle_s2c_chat_message(void)
{
    ...
    chat_message->username.str = (String32*)((u8*)chat_message + chat_message->username.offset);
    chat_message->content.str = (String32*)((u8*)chat_message + chat_message->content.offset);
